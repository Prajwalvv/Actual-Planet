    ...
    >
      ...
      <nav className="nav">
        <div className="nav-inner">
          ...
          <div className="nav-cta">
            ...
            <a href="signup.html" className="btn btn-primary btn-sm">
              Get Started
            </a>
          </div>
          <button
      ...
      >
        ...
        >
          ...
          >
            <a href="https://github.com/Prajwalvv/Actual-Planet" target="_blank" rel="noopener noreferrer" className="btn btn-primary btn-lg" style={{ display: 'flex', alignItems: 'center', gap: '10px' }}>
